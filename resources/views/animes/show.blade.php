            ...
            <div class="sm:mx-auto sm:mt-6 md:mx-auto md:mt-6 lg:mt-6 lg:ml-16">
                <div class="flex flex-col sm:flex-col md:flex-row lg:flex-row space-x-5">
                    ...
                    <div class="buttons flex flex-row justify-end space-x-2">
                        ...
                        <a href="">
                            <button id="delete-button" type="button" class="text-white bg-blue-700 hover:bg-gradient-to-br hover:from-emerald-400 hover:to-blue-700transition ease-in-out duration-150 focus:ring-4 font-medium rounded-3xl text-sm p-2.5 text-center inline-flex items-center me-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
