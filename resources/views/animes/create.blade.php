...
@section('content')
    <form action="/anime" method="POST"
          class="m-10 p-10 w-full max-w-xl mx-auto overflow-hidden bg-white rounded-2xl shadow-blue-700 shadow-md hover:shadow-emerald-400 transition ease-in-out duration-150">
        @csrf
...
{{--                        </div>--}}
            ...
            <div class="my-6">
                <label for="end_aired_date" class="block text-blue-700 mb-2 text-md font-semibold">End Aired
                    Date</label>
                <div class="relative">
                    <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                        <svg class="w-4 h-4 text-blue-700 focus:text-emerald-700" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="my-6 flex min-w-full justify-center">
