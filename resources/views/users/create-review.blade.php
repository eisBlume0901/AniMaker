        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-2">
            ...
            <div class="grid-cols-3">
                ...
                <div class="grid sm:grid-cols-1 md:grid-cols-2 gap-x-2">
                    ...
                    <div class="mb-6">
                        <label for="start_aired_date" class="block text-blue-700 mb-2 ml-2 text-md font-semibold">Start
                            Aired
                            Date</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                <svg class="w-4 h-4 text-blue-700 focus:text-emerald-700"
                    ...
                    <div class="mb-6">
                        <label for="end_aired_date" class="block text-blue-700 mb-2 ml-2 text-md font-semibold">End
                            Aired
                            Date</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
