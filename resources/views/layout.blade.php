            ...
            @auth
                <div class="flex justify-center items-center">
                    <div x-data="{ open: false }" class="w-64 flex justify-center items-center">
                        <div @click="open = !open" class="z-15 relative py-3" :class="{'border-white transform transition duration-300 ': open}" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100">
...
{{--                                        Still has to put the route and its controller--}}
                                        <a href="/users/account" class="flex items-center transform transition-colors duration-200 border-r-4 border-transparent hover:text-emerald-400">
                                            <div class="mr-3">
                                    ...
                                    <li class="font-medium">
{{--                                        Still has to put the route and its controller--}}
                                        <a href="/users/setting" class="flex items-center transform transition-colors duration-200 border-r-4 border-transparent hover:text-emerald-400">
                                            <div class="mr-3">
                                    ...
                                    <li class="font-medium">
                                        <a href="/logout" class="flex items-center transform transition-colors duration-200 border-r-4 border-transparent hover:text-red-700">
